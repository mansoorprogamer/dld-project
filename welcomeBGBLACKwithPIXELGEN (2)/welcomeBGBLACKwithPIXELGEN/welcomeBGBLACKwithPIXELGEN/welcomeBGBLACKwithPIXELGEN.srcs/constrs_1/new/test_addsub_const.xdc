...
set_property PACKAGE_PIN G2 [get_ports ir_signal]
set_property IOSTANDARD LVCMOS33 [get_ports PWM]
set_property PACKAGE_PIN J2 [get_ports PWM]

#J2
set_property IOSTANDARD LVCMOS33 [get_ports ir_signal2]
set_property PACKAGE_PIN G3 [get_ports ir_signal2]          

set_property IOSTANDARD LVCMOS33 [get_ports ir_signal3]
set_property PACKAGE_PIN L2 [get_ports ir_signal3]
